...
private slots:
  ...
  void enableAnnularCorrelate(float center_x_in, float center_y_in,
                              float inside_radius_in, float outside_radius_in,
                              float ri_by_ro_in, float scale_x_in,
                              float scale_y_in);

  void enableBlobCorrelate(v_points xy_blob_in, float scale_x_in,
                           float scale_y_in);
  ...
  bool display_two_images(QString und_file_QString_in,
