...
class Pyramid_class
{
    ...
    std::vector< unsigned char* >   make_pyramid                            ( std::vector< unsigned char* > pyramid_in ,
                                                                              ImageType imageType );

public:
    Pyramid_class( int start_in ,
                   int step_in ,
                   int stop_in ,
                   ...
                   fittingModelEnum fittingModel_in ):
                    ...
                    number_of_interpolation_parameters ( number_of_interpolation_parameters_in ),
    ...
    void                            get_und_center                          ( float &und_x_center_in ,
