...
public:
  ...
  void set_points(int number_of_points_in, float *xy_positions_in,
                  float *def_xy_positions_in, float *model_parameters_in,
                  float und_x_center_in, float und_y_center_in,
                  float *dTxydp_in);
