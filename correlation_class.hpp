...
private:
    ...
    int         number_of_interpolation_parameters = InterpolationClass::get_number_of_interpolation_parameters( interpolationModel );
...
public:		
    CorrelationClass(	int allocated_points_in,
                        ...
                        float required_precision_in,
                        int maximum_iterations_in,
                        int pyramid_start_in,
                        int pyramid_step_in,
                        int pyramid_stop_in ):
