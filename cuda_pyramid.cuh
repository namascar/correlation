...
class cudaPyramid
{
    ...
    std::map< int , cudaPolygon* >     polygons;  // Each polygon object contains the fitting model, und_x and y, und centers, def_x and y, DdilDe.

    cudaImage       *getNewPyramid                   ( const cv::Mat CvImage , ImageType imageType_ , cudaStream_t stream_ );
...
public:
    ...
    void                resetImagePyramids          ( const cv::Mat undCvImage,
    ...
    void                resetPolygon                ( int iSector , float r , float dr , float a , float da ,
                                                      float cx , float cy , int as ,
                                                      fittingModelEnum fittingModel_ );

    void                resetPolygon                ( v_points blobContour ,
                                                      fittingModelEnum fittingModel_ );
    ...
    void                transferParameters          ( int iSector , parameterTypeEnum parSrc , parameterTypeEnum parDst );

    void                updateParameters            ( int iSector,
