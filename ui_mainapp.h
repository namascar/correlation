...
public:
    ...
    void setupUi(QMainWindow *MainApp)
    {
        ...
        scrollArea_all_images->setObjectName(QStringLiteral("scrollArea_all_images"));
        ...
        spinBox_rect_horizontal->setObjectName(QStringLiteral("spinBox_rect_horizontal"));
        ...
        spinBox_rect_vertical->setObjectName(QStringLiteral("spinBox_rect_vertical"));
        ...
        doubleSpinBox_rect_y0->setObjectName(QStringLiteral("doubleSpinBox_rect_y0"));
        ...
        doubleSpinBox_rect_x0->setObjectName(QStringLiteral("doubleSpinBox_rect_x0"));
        ...
        doubleSpinBox_rect_xend->setObjectName(QStringLiteral("doubleSpinBox_rect_xend"));
        ...
        doubleSpinBox_rect_yend->setObjectName(QStringLiteral("doubleSpinBox_rect_yend"));
        ...
        doubleSpinBox_ann_center_x->setObjectName(QStringLiteral("doubleSpinBox_ann_center_x"));
        ...
        doubleSpinBox_ann_center_y->setObjectName(QStringLiteral("doubleSpinBox_ann_center_y"));
        ...
        doubleSpinBox_blob_center_x->setObjectName(QStringLiteral("doubleSpinBox_blob_center_x"));
        ...
        doubleSpinBox_blob_center_y->setObjectName(QStringLiteral("doubleSpinBox_blob_center_y"));
        ...
        doubleSpinBox_blob_x_scale->setObjectName(QStringLiteral("doubleSpinBox_blob_x_scale"));
        ...
        doubleSpinBox_blob_y_scale->setObjectName(QStringLiteral("doubleSpinBox_blob_y_scale"));
        ...
        comboBox_Initial_Guess->setObjectName(QStringLiteral("comboBox_Initial_Guess"));
        ...
        label_Initial_Guess_2->setObjectName(QStringLiteral("label_Initial_Guess_2"));
        label_Initial_Guess_2->setGeometry(QRect(1300, 430, 91, 21));
        label_Initial_Guess_3 = new QLabel(centralwidget);
        label_Initial_Guess_3->setObjectName(QStringLiteral("label_Initial_Guess_3"));
        label_Initial_Guess_3->setGeometry(QRect(1450, 330, 101, 21));
        label_Initial_Guess_4 = new QLabel(centralwidget);
        label_Initial_Guess_4->setObjectName(QStringLiteral("label_Initial_Guess_4"));
        ...
        label_Initial_Guess_5->setObjectName(QStringLiteral("label_Initial_Guess_5"));
        label_Initial_Guess_5->setGeometry(QRect(1450, 380, 91, 21));
        doubleSpinBox_precision = new QDoubleSpinBox(centralwidget);
        doubleSpinBox_precision->setObjectName(QStringLiteral("doubleSpinBox_precision"));
        ...
        label_Initial_Guess_6->setObjectName(QStringLiteral("label_Initial_Guess_6"));
        ...
        label_Initial_Guess_8->setObjectName(QStringLiteral("label_Initial_Guess_8"));
        ...
        label_undeformed_name->setObjectName(QStringLiteral("label_undeformed_name"));
        label_undeformed_name->setGeometry(QRect(190, 620, 541, 31));
        label_undeformed_name->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        ...
        label_deformed_name->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        ...
        label_results_display->setObjectName(QStringLiteral("label_results_display"));
        label_results_display->setGeometry(QRect(750, 10, 541, 17));
        label_best_rotation_value = new QLabel(centralwidget);
        label_best_rotation_value->setObjectName(QStringLiteral("label_best_rotation_value"));
    ...
    {
        MainApp->setWindowTitle(QApplication::translate("MainApp", "MainWindow", 0));
        ...
        actionZoom_in_25->setText(QApplication::translate("MainApp", "Zoom &In (25%)", 0));
        actionZoom_Out_25->setText(QApplication::translate("MainApp", "Zoom &Out (25%)", 0));
        action_Normal_Size->setText(QApplication::translate("MainApp", "&Normal Size", 0));
        actionFit_to_Window->setText(QApplication::translate("MainApp", "&Fit to Window", 0));
        action_Select_Area->setText(QApplication::translate("MainApp", "Select &Area", 0));
        actionParame_ters->setText(QApplication::translate("MainApp", "Parame&ters", 0));
        action_Correlate->setText(QApplication::translate("MainApp", "&Correlate", 0));
        action_About->setText(QApplication::translate("MainApp", "A&bout", 0));
        action_Save_Analysis->setText(QApplication::translate("MainApp", "&Save Report", 0));
        actiong->setText(QApplication::translate("MainApp", "g", 0));
        label_correlation_model->setText(QApplication::translate("MainApp", "Correlation Model", 0));
        label_interpolation_model->setText(QApplication::translate("MainApp", "Interpolation Model", 0));
        label_domain_2->setText(QApplication::translate("MainApp", "Horizontal", 0));
        label_domain_3->setText(QApplication::translate("MainApp", "Subdibisions", 0));
        label_domain_4->setText(QApplication::translate("MainApp", "Vertical", 0));
        label_domain_8->setText(QApplication::translate("MainApp", " X0 (pixel)", 0));
        label_domain_9->setText(QApplication::translate("MainApp", "Y0 (pixel)", 0));
        label_domain_10->setText(QApplication::translate("MainApp", "Yend (pixel)", 0));
        label_domain_11->setText(QApplication::translate("MainApp", "Xend (pixel)", 0));
        QTabWidget_domain->setTabText(QTabWidget_domain->indexOf(Rectangular), QApplication::translate("MainApp", "Rectangular", 0));
        label_domain_6->setText(QApplication::translate("MainApp", "Subdibisions", 0));
        ...
        label_domain_22->setText(QApplication::translate("MainApp", "Ro (pixel)", 0));
        label_domain_23->setText(QApplication::translate("MainApp", "Y0 (pixel)", 0));
        label_domain_24->setText(QApplication::translate("MainApp", " X0 (pixel)", 0));
        label_domain_25->setText(QApplication::translate("MainApp", " Ri (pixel)", 0));
        ...
        QTabWidget_domain->setTabText(QTabWidget_domain->indexOf(Annular), QApplication::translate("MainApp", "Annular", 0));
        ...
        label_domain_26->setText(QApplication::translate("MainApp", "Y0 (pixel)", 0));
        label_domain_31->setText(QApplication::translate("MainApp", "y - Scale", 0));
        label_domain_32->setText(QApplication::translate("MainApp", "x - Scale", 0));
        label_domain_33->setText(QApplication::translate("MainApp", " X0 (pixel)", 0));
        QTabWidget_domain->setTabText(QTabWidget_domain->indexOf(Blob), QApplication::translate("MainApp", "Blob", 0));
        label_domain->setText(QApplication::translate("MainApp", "Domain Type", 0));
        label_Initial_Guess->setText(QApplication::translate("MainApp", "Initial Guess", 0));
        label_Initial_Guess_2->setText(QApplication::translate("MainApp", "Update", 0));
        label_Initial_Guess_3->setText(QApplication::translate("MainApp", "Max Iters", 0));
        label_Initial_Guess_4->setText(QApplication::translate("MainApp", "Color", 0));
        label_Initial_Guess_5->setText(QApplication::translate("MainApp", "Precision", 0));
        label_Initial_Guess_6->setText(QApplication::translate("MainApp", "Start Pyramid", 0));
        label_stop_pyram->setText(QApplication::translate("MainApp", "Stop Pyramid", 0));
        label_Initial_Guess_8->setText(QApplication::translate("MainApp", "Pyramid  Step", 0));
        pushButton_show_sets->setText(QApplication::translate("MainApp", "Show Sets", 0));
        pushButton_correlate->setText(QApplication::translate("MainApp", "Correlate", 0));
        label_undeformed_name->setText(QApplication::translate("MainApp", "Undeformed Image", 0));
        label_deformed_name->setText(QApplication::translate("MainApp", "Deformed Image", 0));
        label_results_display->setText(QString());
        label_best_rotation_value->setText(QString());
        label_best_rotation->setText(QApplication::translate("MainApp", "Best Rotation(deg)", 0));
