...
class polygon_class
{
 protected:
    ...
    v_points        trianglePoints         ( vertexStruct *v1 ,
                                             vertexStruct *v2 ,
                                             vertexStruct *v3 );

    v_points        flatTrianglePoints     ( vertexStruct *v1 ,
                                             vertexStruct *v2 ,
                                             vertexStruct *v3 );

    float           areaTwice              ( vertexStruct *v1 ,
                                             vertexStruct *v2 ,
                                             vertexStruct *v3 );


    bool            left                   ( vertexStruct *v1 ,
                                             vertexStruct *v2 ,
                                             vertexStruct *v3 );

    bool            leftOn                 ( vertexStruct *v1 ,
                                             vertexStruct *v2 ,
                                             vertexStruct *v3 );

    bool            collinear              ( vertexStruct *v1 ,
                                             vertexStruct *v2 ,
                                             vertexStruct *v3 );

    bool            intersectProp          ( vertexStruct *v1 ,
                                             vertexStruct *v2 ,
                                             vertexStruct *v3 ,
                                             vertexStruct *v4 );

    bool            between                ( vertexStruct *v1 ,
                                             vertexStruct *v2 ,
                                             vertexStruct *v3 );

    bool            intersect              ( vertexStruct *v1 ,
                                             vertexStruct *v2 ,
                                             vertexStruct *v3 ,
                                             vertexStruct *v4 );

    bool            diagonalIE             ( vertexStruct *v1 ,
                                             vertexStruct *v2 );

    bool            inCone                 ( vertexStruct *v1 ,
                                             vertexStruct *v2 );

    bool            diagonal               ( vertexStruct *v1 ,
                                             vertexStruct *v2 );
