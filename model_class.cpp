...
void ModelClass::set_points(int number_of_points_in, float *xy_positions_in,
                            float *def_xy_positions_in,
                            float *model_parameters_in, float und_x_center_in,
...
void ModelClass_U::compute_model() {
  ...
  for (int ipoint = 0; ipoint < number_of_points; ++ipoint) {
    ...
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 0] = 0;
  }
...
void ModelClass_UV::compute_model() {
  ...
  for (int ipoint = 0; ipoint < number_of_points; ++ipoint) {
    ...
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 0] = 0;
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 1] = 1;
  }
...
void ModelClass_UVQ::compute_model() {
  ...
  for (int ipoint = 0; ipoint < number_of_points; ++ipoint) {
    ...
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 1] = 1;
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 2] = dx;
  }
...
void ModelClass_UVUxUyVxVy::compute_model() {
  ...
  for (int ipoint = 0; ipoint < number_of_points; ++ipoint) {
    ...
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 1] = 1;
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 2] = 0;
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 3] = 0;
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 4] = dx;
    dTxydp[ipoint * (number_of_model_parameters * 2) +
           number_of_model_parameters + 5] = dy;
  }
...
ModelClass *ModelClass::new_ModelClass(const fittingModelEnum &fittingModel_in,
  ...
  case fm_UVUxUyVxVy: {
    ...
    ModelClass_UVUxUyVxVy *UVUxUyVxVy =
        new ModelClass_UVUxUyVxVy[number_of_threads];
...
int ModelClass::get_thread_id() { return thread_id; }

float ModelClass::get_time() { return time_duration_model; }

void ModelClass::set_thread_id(int thread_id_in) { thread_id = thread_id_in; }
...
void ModelClass::debug_model() {
  ...
  std::cout << "und xy points for thread " << thread_id
            << " #points = " << number_of_points << std::endl;
  std::cout << "und_x0 = " << und_x_center << " und_y0 = " << und_y_center
            << std::endl;
  std::cout << "def_x0 = " << def_x_center << " def_y0 = " << def_y_center
            << std::endl;
  ...
  for (int ipoint = 0; ipoint < number_of_points; ++ipoint) {
    std::cout << "point " << ipoint << ", und_xy ("
              << xy_positions[ipoint * 2 + 0] << ","
