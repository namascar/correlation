...
signals:
    void valueChanged_rectangularSelected( float center_x, float center_y, float right_x, float right_y, float left_x, float left_y,  float clickScale_x, float clickScale_y);
    void valueChanged_annularSelected    ( float center_x, float center_y, float inside_radius, float outside_radius, float ri_by_ro, float clickScale_x, float clickScale_y);
    void valueChanged_blobSelected       ( v_points xy_blob, float clickScale_x, float clickScale_y);

    void valueChanged_selectingRectangular(float center_x_in, float center_y_in, float right_x_in, float right_y_in,
    ...
    void valueChanged_selectingBlob(float center_x_in, float center_y_in, v_points xy_blob_in,
                                    float clickScale_x_in, float clickScale_y_in);
    void update_mirror();
...
private slots:
    void scaleSquare();
    void mirrorSelectionRectangular(float center_x_in, float center_y_in, float right_x_in, float right_y_in,
                         float left_x_in, float left_y_in, float clickScale_x_in, float clickScale_y_in);
    void mirrorSelectionAnnular(float center_x_in, float center_y_in,
                                float r_inside_in, float r_outside_in, float ri_by_ro_in,
                                float clickScale_x_in, float clickScale_y_in);
    void mirrorSelectionBlob(float center_x_in, float center_y_in, v_points xy_blob_in,
                             float clickScale_x_in, float clickScale_y_in);
